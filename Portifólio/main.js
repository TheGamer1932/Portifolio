document.getElementById("filterInput").addEventListener("keyup", function() {
  ...
  for (var i = 0; i < projects.length; i++) {
      ...
      var projectTitle = project.getAttribute("data-title").toLowerCase();
      var projectCategory = project.getAttribute("data-category").toLowerCase();
      var projectKeywords = project.getAttribute("data-keywords").toLowerCase();

      if (filterOption === "title" && projectTitle.indexOf(filterValue) > -1) {
          project.style.display = "";
      } else if (filterOption === "category" && projectCategory.indexOf(filterValue) > -1) {
          project.style.display = "";
      } else if (filterOption === "keyword" && projectKeywords.indexOf(filterValue) > -1) {
          project.style.display = "";
      } else {
